...
module.exports = "<div id=\"search-component\">\n  <h4>Hero Search</h4>\n  <input #searchBox id=\"search-box\" (input)=\"search(searchBox.value)\" type=\"text\">\n  <ul class=\"search-results\">\n    <li *ngFor=\"let hero of heroes$|async\">\n      <a routerLink=\"/detail/{{hero.id}}\">{{hero.name}}</a>\n    </li>\n  </ul>\n</div>\n"
...
var HeroSearchComponent = /** @class */ (function () {
    ...
    HeroSearchComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.heroes$ = this.searchTerms.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["debounceTime"])(300), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["distinctUntilChanged"])(), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(function (term) { return _this.heroService.searchHero(term); }));
    };
...
var HeroesComponent = /** @class */ (function () {
    ...
    HeroesComponent.prototype.delete = function (hero) {
        this.heroes = this.heroes.filter(function (h) { return h.id !== hero.id; });
...
var HeroService = /** @class */ (function () {
    ...
    HeroService.prototype.getHeroes = function () {
        ...
        return this.http.get(this.heroesUrl)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.log('fetched heroes'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('getHeroes', [])));
    };
    ...
    HeroService.prototype.getHero = function (id) {
        ...
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.log('fetched hero id=${id}'); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError("getHero id=" + id)));
    };
    ...
    HeroService.prototype.deleteHero = function (hero) {
        ...
        var url = this.heroesUrl + "/" + id;
        return this.http.delete(url, this.httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.log("deleted hero id=" + id); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('deleteHero')));
    };
    HeroService.prototype.searchHero = function (term) {
        ...
        return this.http.get(this.heroesUrl + "/?name=" + term).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])(function () { return _this.log("found heroes matching \"" + term + "\""); }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError('searchHeroes', [])));
    };
...
var InMemoryDataService = /** @class */ (function (_super) {
...
}(angular_in_memory_web_api__WEBPACK_IMPORTED_MODULE_1__["InMemoryDbService"]));
...
module.exports = __webpack_require__(/*! /Users/home/workspace/current/hero-list/src/main.ts */"./src/main.ts");
